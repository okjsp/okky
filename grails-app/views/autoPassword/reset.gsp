    ...
    <div class="col-sm-8 col-sm-offset-2">
        <div class="panel panel-default panel-margin-10">
            <div class="panel-body panel-body-content text-center">
                ...
                <p>회원 가입시 입력하신 이메일 주소를 입력하시면,<br/> 해당 이메일로 AutoPassword™ 재설정 링크를 보내드립니다.</p>
                ...
                <button type="submit" class="btn btn-primary">AutoPassword™ 재설정</button> <g:link uri="/" class="btn btn-default">취소</g:link>
            </div>
        </div>
    </div>
    </g:form>
