    ...
    <div class="panel panel-default panel-margin-10">
        <div class="panel-body panel-body-content text-center">
            ...
            <ul class="text-left">
                ...
                <li><strong>작성된 게시물은 익명처리 됩니다.</strong></li>
            </ul>
            <g:link controller="login" action="auth" class="btn btn-default">아니오</g:link>
            <g:link controller="login" action="auth" class="btn btn-danger">예, 탈퇴하겠습니다.</g:link>
        </div>
    </div>
</div>
</body>
