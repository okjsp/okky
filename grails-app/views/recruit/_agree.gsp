    <div class="form-group ${hasErrors(bean: recruit, field: 'jobType', 'has-error')} has-feedback">
        <p>OKKY 구인 게시판 이용자 여러분, 안녕하세요.</p>
        <p>OKKY Jobs 운영진입니다 :)</p>
        <br/>
        ...
        <ol class="list">
            <li><p><strong>하나의 게시글에는 하나의 프로젝트 정보만 등록 가능합니다.</strong> 이를 어길 시 관리자에 의해 별도 통보 없이 삭제될 수 있습니다.</p></li>

            <li><p>업체와 개인이 등록한 구인/구직 게시물은 <strong>OKKY의 공식자료가 아닙니다.</strong> 따라서 OKKY는 금전적인 문제 등에 대한 책임이 없습니다.</p></li>

            <li><p>게시판 <strong>운영 취지에 맞지 않는 글</strong>은 별도 통보 없이 삭제될 수 있습니다.</p></li>
        </ol>
