...
<div id="list-article" class="content scaffold-list list-recruit" role="main">
    <div class="nav" role="navigation">
        <g:link class="create btn btn-success btn-wide pull-right" uri="/recruits/create"><i
                class="fa fa-pencil"></i> <g:message code="default.new.label" args="[entityName]"/></g:link>
            ...
            <g:form name="category-filter-form" method="get" uri="/articles/${category.code}">
                <div class="category-filter-query pull-right">
                    <div class="input-group input-group-sm">
                        <input type="search" name="query" class="form-control" placeholder="검색어"
                               value="${params.query}"/>
                        <span class="input-group-btn">
                            <button type="submit" class="btn btn-default"><i class="fa fa-search"></i></button>
                            <g:if test="${params.query}">
                                <g:link uri="/articles/${category.code}" class="btn btn-warning"><i
                                        class="fa fa-times-circle"></i> clear</g:link>
                            </g:if>
                        </span>
                    </div>
                </div>
                <ul class="list-sort pull-left">
                    <li><g:link uri="/recruits" params="[sort: 'id', order: 'desc']" data-sort="id" data-order="desc"
                                class="category-sort-link ${params.sort == 'id' ? 'active' : ''}">최신순</g:link></li>
                    <li><g:link uri="/recruits" params="[sort: 'voteCount', order: 'desc']" data-sort="voteCount"
                                data-order="desc"
                                class="category-sort-link ${params.sort == 'voteCount' ? 'active' : ''}">추천순</g:link></li>
                    <li><g:link uri="/recruits" params="[sort: 'noteCount', order: 'desc']" data-sort="noteCount"
                                data-order="desc"
                                class="category-sort-link ${params.sort == 'noteCount' ? 'active' : ''}">댓글순</g:link></li>
                    <li><g:link uri="/recruits" params="[sort: 'scrapCount', order: 'desc']" data-sort="scrapCount"
                                data-order="desc"
                                class="category-sort-link ${params.sort == 'scrapCount' ? 'active' : ''}">스크랩순</g:link></li>
                    <li><g:link uri="/recruits" params="[sort: 'viewCount', order: 'desc']" data-sort="viewCount"
                                data-order="desc"
                                class="category-sort-link ${params.sort == 'viewCount' ? 'active' : ''}">조회순</g:link></li>
                </ul>
                        ...
                        <li class="list-group-item ${category?.useEvaluate ? 'list-group-item-question' : ''} list-group-${evaluateClass} clearfix">
                            ...
                            <div class="list-title-wrapper clearfix">
                                <div class="list-tag clearfix">
                                    ...
                                    <a href="${request.contextPath}/articles/tagged/${tag}"
                                       class="list-group-item-text item-tag label label-success">Editor's Choice</a>
                                    <span class="label ${article.recruit.jobType == JobType.valueOf('FULLTIME') ? 'label-primary' : 'label-success'}"><g:message
                                    ...
                                    <div class="list-group-item-summary clearfix">
                                        <ul>
                                            ...
                                            <li class="${article.viewCount == 0 ? 'item-icon-disabled' : ''}"><i
                                                    class="item-icon fa fa-eye"></i> <g:shorten
                                                    number="${article.viewCount}"/></li>
                                        </ul>
                                    </div>
                                </g:else>
                            </div>
                            ...
                            <div class="list-group-item-author clearfix">
                                <g:avatar avatar="${article.displayAuthor}" size="list"
                ...
                <li class="list-group-item ${category?.useEvaluate ? 'list-group-item-question' : ''} list-group-${evaluateClass} clearfix">
                    ...
                    <div class="list-group-item-author clearfix">
                        <div class="avatar avatar-list clearfix"><a href="/okky/user/info/2" class="avatar-photo avatar-company"><img
                                src="${grailsApplication.config.grails.fileURL}/logo/${article.recruit.company.logo}">
                        </a>

                        <div class="avatar-info"><a class="nickname" href="/okky/company/info/${article.recruit.company.id}">${article.recruit.company.name}</a>
    ...
    <div class="text-center">
        <g:if test="${articlesCount > 0}">
            <g:paginate uri="/recruits" class="pagination-sm" total="${articlesCount ?: 0}"/>
        </g:if>
    </div>
</div>
<content tag="script">
