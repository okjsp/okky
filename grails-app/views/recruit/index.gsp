                ...
                <div class="category-filter-wrapper">
                    <g:form name="category-filter-form" method="get" uri="/articles/${category.code}">
                        ...
                        <ul class="list-sort pull-left">
                            <li><g:link uri="/recruits" params="[sort:'id', order:'desc']" data-sort="id" data-order="desc" class="category-sort-link ${params.sort == 'id' ? 'active':''}">최신순</g:link></li>
                            <li><g:link uri="/recruits" params="[sort:'voteCount', order:'desc']" data-sort="voteCount" data-order="desc" class="category-sort-link ${params.sort == 'voteCount' ? 'active':''}">추천순</g:link></li>
                            <li><g:link uri="/recruits" params="[sort:'noteCount', order:'desc']" data-sort="noteCount" data-order="desc" class="category-sort-link ${params.sort == 'noteCount' ? 'active':''}">댓글순</g:link></li>
                            <li><g:link uri="/recruits" params="[sort:'scrapCount', order:'desc']" data-sort="scrapCount" data-order="desc" class="category-sort-link ${params.sort == 'scrapCount' ? 'active':''}">스크랩순</g:link></li>
                            <li><g:link uri="/recruits" params="[sort:'viewCount', order:'desc']" data-sort="viewCount" data-order="desc" class="category-sort-link ${params.sort == 'viewCount' ? 'active':''}">조회순</g:link></li>
                        </ul>
                                            ...
                                            ${fieldValue(bean: article, field: "title")}
																		...
																		<g:if test="${article.recruit}">
																			<div class="detail-info">
																			  <span class="label ${article.recruit.jobType == JobType.valueOf('FULLTIME') ? 'label-primary' : 'label-success'}"><g:message code="recruit.jobType.${article.recruit.jobType}"/></span>
																				<span>지역:</span> <span>${article.recruit.city}</span> <span>/</span>
																				<span>급여:</span> <span>${article.recruit.jobPayType}</span> <span>/</span>
																				<span>직무:</span> <span>${article.recruit.jobPositionType}</span>
																			</div>
																		</g:if>
                                </div>
